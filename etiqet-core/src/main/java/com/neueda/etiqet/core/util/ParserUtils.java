...
public class ParserUtils {
    ...
    /**
     * By default, when creating a CdrItem, the type is set to CDR_STRING and never changed in {@link #getCdrItem} This
     * means every non-String CdrItem is handled incorrectly.
     *
