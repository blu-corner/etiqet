...
public class ClientFactory {
  ...
  /**
   * Sets the client delegates for the client from the protocol config. Suppresses unchecked
   * warnings because we're ignoring the generics from the ClientDelegate class.
   *
