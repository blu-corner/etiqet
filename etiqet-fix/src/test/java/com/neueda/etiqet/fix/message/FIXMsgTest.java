...
import com.neueda.etiqet.fix.message.dictionary.*;
...
public class FIXMsgTest {
    ...
    public void testBasicMessageTypes() throws EtiqetException, FieldNotFound {
        ...
        FIXMsg fixMsg = new FIXMsg() {
            @Override
            ProtocolConfig getFixProtocol() {
                return protocolConfig;
            }
        };
        quickfix.FieldMap fixMessage = fixMsg.serialize(newOrderSingle);
